...
function validateAsset(asset, argument, errorPrefix) {
    ...
    if ((!constants_1.cTokens.includes(cTokenName) || !constants_1.underlyings.includes(underlyingName)) &&
        ...
        console.log(constants_1.cTokens, constants_1.underlyings, constants_1.opfAssets);
        console.log(cTokenName, constants_1.cTokens.includes(cTokenName), constants_1.underlyings.includes(underlyingName), constants_1.opfAssets.includes(underlyingName));
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    console.log({ underlyingName: underlyingName, inAssetUnderlyingName: inAssetUnderlyingName });
